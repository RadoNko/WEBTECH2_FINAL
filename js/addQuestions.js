function addQuestionMultiple() {
  ...
  questions.insertAdjacentHTML(
    ...
    `<form id='` +
      ...
      questionType +
      questionTypeNumber +
      `' onclick='deleteQuestion(this.value)'>Delete</button>
      ...
      `Radio1" value="1">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="answer` +
      questionTypeNumber +
      `Radio1" id="noRadio" value="0">
                                            <label class="form-check-label" for="noRadio">No</label>
                                        </div>
                                        <input type="text" name="answer` +
      questionTypeNumber +
      `Text1" class="form-control" placeholder="Answer is...">
  ...
  question.insertAdjacentHTML(
    "beforeend",
    `<button type="button" class="addAnswerMultiple btn btn-info" onclick="addAnswerQuestionMultiple(` +
      questionTypeNumber +
...
function addAnswerQuestionMultiple(number) {
  ...
  answers.insertAdjacentHTML(
    ...
    `<label>Is this answer correct ?</label>
      ...
      `Text` +
      answerNumber +
      `" class="form-control" placeholder="Answer is...">
                               `
  );
}
...
function addQuestionConnect() {
  ...
  question.insertAdjacentHTML(
    "beforeend",
    `<button type="button" class="addAnswerConnect btn btn-info" onclick="addQuestionConnectPair(` +
      questionTypeNumber +
