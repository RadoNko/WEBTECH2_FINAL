...
<main class="w-1/2 bg-gray-200 p-4">
    ...
    <div>
        ...
        <p>To receive notifications of students leaving exam you need to be logged in as a Teacher. If an exam is active you will receive red notifications upon students leave on the left panel.
        </p>
