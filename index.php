...
<script>//programmatically set value
...
<script> //render all static math expressions
...
<script> //init all editable math expressions + onchange set input value to LaTeX format
